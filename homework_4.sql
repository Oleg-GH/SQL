...
select 					-- (решение с вложенными запросами) 
	from_user_id 
	, concat(
...
-- ---------------------------------------------------------------
/*Задача 4
 Определить общее количество лайков, которые получили пользователи младше 18 лет.
...
SELECT  gender, COUNT(*)		-- решение с объединением таблиц
from likes
