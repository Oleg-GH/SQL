...
/* 1.	Создайте представление с произвольным SELECT-запросом 
		из прошлых уроков [CREATE VIEW]
*/
...
CREATE OR REPLACE VIEW friends_amount AS 		# другой вариант
SELECT 
	COUNT(*) AS cnt,
	u.id
FROM users AS u
